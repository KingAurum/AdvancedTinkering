...
{
    public class VenomEnchantment : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Venom Enchantment");
            Tooltip.SetDefault("Melee attacks inflict enemies with Venom.");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(1339, 60);     //Vial of Venom
        ...
        {
            player.AddBuff(mod.BuffType("VenomEnchantment"), 86400);
            return true;
        }
    }
}
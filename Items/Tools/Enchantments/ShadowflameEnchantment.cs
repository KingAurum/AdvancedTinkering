...
{
    public class ShadowflameEnchantment : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Shadowflame Enchantment");
            Tooltip.SetDefault("Melee attacks inflict enemies with Shadowflame.");
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(null, "Shadowspark", 120);
        ...
        {
            player.AddBuff(mod.BuffType("ShadowflameEnchantment"), 86400);
            return true;
        }
    }
}